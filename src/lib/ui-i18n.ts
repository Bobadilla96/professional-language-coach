...
const EN_TEXT = {
  ...
  scenarioGuideDescription: "Use this brief to stay focused before sending your message.",
  coachFocusTitle: "Coach focus",
  ...
  coaching: "Coaching...",
  speakMyMessage: "Read my draft",
  listenCoachReply: "Listen to coach reply",
  browserVoiceTitle: "Browser voice tools",
  browserVoiceDescription: "Production-safe fallback using your browser speech synthesis and speech recognition.",
  browserVoiceReady: "Browser voice is ready.",
  browserVoiceUnavailable: "Browser voice is not available in this browser.",
  browserVoiceFallbackActive: "VibeVoice is unavailable here, so browser voice fallback is active.",
  dictationStart: "Start dictation",
  dictationStop: "Stop dictation",
  dictationUnavailable: "Speech recognition is not available in this browser.",
  dictationListening: "Listening...",
  resetConversation: "Reset conversation",
  sessionStatus: "Session status",
  totalTurns: "Total turns",
  latestCoachReply: "Latest coach reply",
  noCoachReplyYet: "No coach reply yet.",
  ...
  vibevoiceUnavailableHint: "In production, use browser voice when the local VibeVoice server is not reachable.",
...
const UI_TEXT: Record<AppLanguage, UiTextMap> = {
  ...
  es: {
    ...
    scenario: "Escenario",
    scenarioGuide: "Guia del escenario",
    scenarioGuideDescription: "Usa este brief para mantener foco antes de enviar tu mensaje.",
    coachFocusTitle: "En que te corrige el coach",
    starterPromptsTitle: "Prompts para empezar",
    ...
    speakMyMessage: "Leer mi borrador",
    listenCoachReply: "Escuchar respuesta del coach",
    browserVoiceTitle: "Herramientas de voz del navegador",
    browserVoiceDescription: "Fallback seguro para produccion usando sintesis y reconocimiento de voz del navegador.",
    browserVoiceReady: "La voz del navegador esta lista.",
    browserVoiceUnavailable: "La voz del navegador no esta disponible en este browser.",
    browserVoiceFallbackActive: "VibeVoice no esta disponible aqui, asi que se usa el fallback de voz del navegador.",
    dictationStart: "Iniciar dictado",
    dictationStop: "Detener dictado",
    dictationUnavailable: "El reconocimiento de voz no esta disponible en este browser.",
    dictationListening: "Escuchando...",
    resetConversation: "Reiniciar conversacion",
    sessionStatus: "Estado de la sesion",
    totalTurns: "Turnos totales",
    latestCoachReply: "Ultima respuesta del coach",
    noCoachReplyYet: "Todavia no hay respuesta del coach.",
    ...
    vibevoiceUnavailableHint: "En produccion, usa la voz del navegador cuando el servidor local de VibeVoice no este disponible.",
